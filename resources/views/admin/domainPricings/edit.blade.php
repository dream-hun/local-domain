...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.domain-pricings.update', [$domainPricing->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tld') ? 'is-invalid' : '' }}" type="text" name="tld"
                        id="tld" value="{{ old('tld', $domainPricing->tld) }}" required>
                    @if ($errors->has('tld'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('registration_price') ? 'is-invalid' : '' }}" type="number"
                        name="registration_price" id="registration_price"
                        value="{{ old('registration_price', $domainPricing->registration_price) }}" step="1"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('renewal_price') ? 'is-invalid' : '' }}" type="number"
                        name="renewal_price" id="renewal_price"
                        value="{{ old('renewal_price', $domainPricing->renewal_price) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('transfer_price') ? 'is-invalid' : '' }}" type="number"
                        name="transfer_price" id="transfer_price"
                        value="{{ old('transfer_price', $domainPricing->transfer_price) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('whois_privacy_price') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('whois_privacy_price', $domainPricing->whois_privacy_price) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('min_registration_years') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('min_registration_years', $domainPricing->min_registration_years) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('max_registration_years') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('max_registration_years', $domainPricing->max_registration_years) }}" step="1">
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1"
                            {{ $domainPricing->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
